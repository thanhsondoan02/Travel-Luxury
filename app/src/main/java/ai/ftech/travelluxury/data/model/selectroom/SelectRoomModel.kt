...
class SelectRoomModel {
    ...
    fun fromHotelDetail() {
        this.hotelId = HotelDetailModel.INSTANCE.hotelInfo?.id
        this.hotelName = HotelDetailModel.INSTANCE.hotelInfo!!.hotelName
        this.hotelAddress = HotelDetailModel.INSTANCE.hotelInfo!!.address
    }
...
//    val imageList1 =
//        listOf(image1, image2, image3, image4, image5, image1, image2, image3, image4, image5)
//    val imageList2 = listOf(image2, image3)
//    val imageList3 = listOf(image3, image4, image5)
//    val imageList4 = listOf(image4)
...
//    )
//
//    SelectRoomModel.INSTANCE.roomList =
//        listOf(room1, room2, room3, room4, room5, room6, room7, room8)
//}
